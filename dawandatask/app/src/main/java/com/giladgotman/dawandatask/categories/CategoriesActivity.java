...
import com.giladgotman.dawandatask.util.ActivityUtils;
import dagger.Lazy;
import dagger.android.support.DaggerAppCompatActivity;

import javax.inject.Inject;

public class CategoriesActivity extends DaggerAppCompatActivity {

    private static final String CURRENT_FILTERING_KEY = "CURRENT_FILTERING_KEY";
    @Inject
    CategoriesPresenter categoriesPresenter;
    @Inject
    Lazy<CategoriesFragment> taskFragmentProvider;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (categoriesFragment == null) {
            ...
            categoriesFragment = taskFragmentProvider.get();
...
//        outState.putSerializable(CURRENT_FILTERING_KEY, categoriesPresenter.getFiltering());
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        switch (menuItem.getItemId()) {
                            ...
                            case R.id.statistics_navigation_menu_item:
                                Intent intent =
                                        new Intent(CategoriesActivity.this, StatisticsActivity.class);
